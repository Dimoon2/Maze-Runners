...
public class Boss
{
    ...
    public static void Victory(Player player)
    {
        ...
        Console.WriteLine(@"                       I,I");
        Console.WriteLine(@"                      //#\\");
        Console.WriteLine(@"                    .dH # Hb.");
        Console.WriteLine(@"                _.~d#XP I 7X#b~,_");
        Console.WriteLine(@"              _.dxXVP^Y X Y^7^VXb._");
        Console.WriteLine(@"             /AP^ \PY   Y   Y7/  ^VA\");
        Console.WriteLine(@"             /8/   \PP  I  77/    \8\");
        Console.WriteLine(@"            /J/     IV     VI      \L\");
        ...
        Console.WriteLine(@"       \( |         |   Y   |         | )/");
        Console.WriteLine(@"        | |         |   |   |  )      | |");
        Console.WriteLine(@"      J | __...~~--'|   |   |`--~~___ | L");
        Console.WriteLine(@"        >-+< ..._   |   |   |   __...>+-<");
        Console.WriteLine(@"       /     _ `--~.L___L___J.~-- __    \");
        Console.WriteLine(@"      K    /  ` --.   d===b      . ' \   H");
        Console.WriteLine(@"      \_._/      \   // I \\   /      \_._/");
        Console.WriteLine(@"         `--._    \__\\ I //__/  _..~--'");
